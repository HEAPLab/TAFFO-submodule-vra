...
namespace taffo {
    ...
    using handler_function = void(*)(std::string& callee, llvm::User::const_op_iterator& arg_it, std::list<taffo::range_s_ptr_t>& arg_ranges);
    ...
    void handleIndirectCall(std::string& callee, llvm::User::const_op_iterator& arg_it, std::list<taffo::range_s_ptr_t>& arg_ranges);
}
